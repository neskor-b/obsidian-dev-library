...
Розділ 8 розвиває цю ідею: перш ніж додати параметр, перевір, чи користувач здатний обрати краще значення, ніж модуль. Протокол може вимірювати час успішних відповідей і на його основі визначати інтервал повторного запиту. Таке значення пристосовується до умов, тоді як ручне налаштування може застаріти.

Це приклад принципу, а не повна специфікація алгоритму повторів. Якщо ж рішення залежить від знань користувача — наприклад, від важливості запиту, — явний параметр має сенс.
