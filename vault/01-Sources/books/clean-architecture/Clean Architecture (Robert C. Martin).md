...
Ця книга не має власної `03-Concepts/`: локальні ідеї, які не стали спільними концептами, лишаються всередині відповідної chapter-note. Короткий підсумок розділу, практичні правила й приклади коду варто тримати всередині chapter-note.
