...
## Приклад: коли зміна стає надто дорогою

Уявімо систему бронювання, де поточні сценарії працюють: бронювання створюються, оплата проходить, листи надсилаються. Проте додавання групового бронювання змушує змінювати багато пов'язаних модулів і повторно перевіряти старі сценарії. Поведінкова цінність системи ще є, але її здатність дешево змінюватися слабшає. Якщо витрати на кожну нову вимогу ростуть, команда дедалі рідше може реалізувати потрібні бізнесу зміни.

^clean-architecture-ch02-example-booking-system
