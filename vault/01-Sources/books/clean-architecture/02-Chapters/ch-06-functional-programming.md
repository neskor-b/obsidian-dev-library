...
Архітектурний сенс `functional programming` полягає в дисципліні незмінності. Незмінні значення зменшують ризик гонок навколо спільного стану й потребу в блокуваннях. Тому якомога більше логіки варто розміщувати в `immutable` частинах системи, а неминучу мутацію — ізолювати, захищати й робити максимально вузькою.
